...
namespace Modules\Users\Parents\Database\Seeders;
...
class ParentsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        if (app()->environment('production')) {
            $this->command->warn('ParentsSeeder will not run in production.');
            return;
        }
        ...
        $this->command->info(count($parents) . ' default parents created.');
    }
}
